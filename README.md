# [Alan Flutter SDK](https://pub.dev/packages/alan_voice)
...
2. Use the Alan Flutter plugin to embed the Alan button to your application or page. For details, see [Alan AI documentation](https://alan.app/docs/client-api/cross-platform/flutter).
